...
public class StudentHomepage2 {
 public StudentHomepage2() {
 ...
 NS = new JLabel("Diolata, Justine Irish");
 NS.setBounds(60, 80, 250,30);
 jf.add(NS); 
 ...
 HA = new JLabel("Purok 3 Blk 3 Lot 10 Jonelta Housing Sto. Niño Biñan Laguna");
